APICEFLOW Pte. Ltd. - GEOLOCATION MAP USING THREE.JS
...
<figure>
	<figcaption>On the left, the geometry was generated in CPU. On the right, the geometry was displaced directly in the vertex shader:</figcaption>
...
- Below is an implementation of a provider to access [OpenStreetMaps](https://www.openstreetmap.org/) tile data using the [Tile API](https://wiki.openstreetmap.org/wiki/Tiles). The provider simply loads the URL data into a image element.
